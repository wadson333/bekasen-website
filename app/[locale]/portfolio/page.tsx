...
const HEADER: Record<Locale, { eyebrow: string; titleBefore: string; titleAccent: string; titleAfter: string; subtitle: string }> = {
  fr: {
    eyebrow: "Portfolio",
    titleBefore: "Sites en ",
    titleAccent: "production",
    titleAfter: ". Vrais clients. Vraies données.",
    subtitle: "Pas de mockups Figma ni de concepts. Chaque projet ci-dessous tourne aujourd'hui en ligne, avec son code source remis au client.",
  },
  en: {
    eyebrow: "Portfolio",
    titleBefore: "Live in ",
    titleAccent: "production",
    titleAfter: ". Real clients. Real data.",
    subtitle: "No Figma mockups, no concept art. Every project below ships in production today, with the source code handed over to the client.",
  },
  ht: {
    eyebrow: "Portfolio",
    titleBefore: "An ",
    titleAccent: "pwodiksyon",
    titleAfter: ". Vrè kliyan. Vrè done.",
    subtitle: "Pa gen mokòp Figma ni konsepsyon. Chak pwojè anba a ap mache jodi a, ak kòd sous a remèt bay kliyan an.",
  },
  es: {
    eyebrow: "Portafolio",
    titleBefore: "En ",
    titleAccent: "producción",
    titleAfter: ". Clientes reales. Datos reales.",
    subtitle: "Sin mockups de Figma ni conceptos. Cada proyecto debajo está en producción hoy, con el código fuente entregado al cliente.",
  },
};
